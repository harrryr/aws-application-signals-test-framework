...
resource "null_resource" "deploy" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      cd ~
      aws s3api get-object --bucket aws-appsignals-sample-app-prod-us-east-1-2 --key python-frontend-service-depl-${var.repository}.yaml python-frontend-service-depl.yaml
      aws s3api get-object --bucket aws-appsignals-sample-app-prod-us-east-1-2 --key python-remote-service-depl-${var.repository}.yaml python-remote-service-depl.yaml
