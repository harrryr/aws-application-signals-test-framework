...
resource "null_resource" "deploy" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      cd ~
      aws s3api get-object --bucket aws-appsignals-sample-app-prod-us-east-1-2 --key frontend-service-depl-${var.repository}.yaml frontend-service-depl.yaml
      aws s3api get-object --bucket aws-appsignals-sample-app-prod-us-east-1-2 --key remote-service-depl-${var.repository}.yaml remote-service-depl.yaml
